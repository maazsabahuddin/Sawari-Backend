...
from User.views import Register, IsVerified, UserLogin, UserLogout, UserResendOtp, ForgotPassword, PasswordChange
...
urlpatterns = [
    ...
    path('forget_password/', ForgotPassword.as_view(), name='forgot_password'),
