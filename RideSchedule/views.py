...
from A import DISTANCE_KILOMETRE_LIMIT, gmaps, local_tz, STOP_WAIT_TIME
...
class BusRoute(generics.GenericAPIView):
    ...
    def return_stops_of_a_ride(**kwargs):
        try:
            ...
            nearest_user_stops = BusRoute.distance_and_duration(stops_obj=route_obj.stop_ids.get_queryset(),
