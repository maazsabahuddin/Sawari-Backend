...
def assert_string_list(dist, attr, value):
    """User that value is a string list or None"""
    try:
...
def check_nsp(dist, attr, value):
    """User that namespace packages are valid"""
    ns_packages = value
...
def check_extras(dist, attr, value):
    """User that extras_require mapping is valid"""
    try:
...
def assert_bool(dist, attr, value):
    """User that value is True, False, 0, or 1"""
    if bool(value) != value:
...
def check_requirements(dist, attr, value):
    """User that install_requires is a valid requirements list"""
    try:
...
def check_specifier(dist, attr, value):
    """User that value is a valid version specifier"""
    try:
...
def check_entry_points(dist, attr, value):
    """User that entry_points map is parseable"""
    try:
...
def check_package_data(dist, attr, value):
    """User that value is a dictionary of package names to glob lists"""
...
class Feature:
    ...
    **deprecated** -- The `Feature` facility was never completely implemented
    ...
    def validate(self, dist):
        """User that feature makes sense in context of distribution
