...
class ServiceList(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.ServiceList>'
...
class ServicePage(Page):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.ServicePage>'
...
class ServiceContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.User.V2.ServiceContext {}>'.format(context)
...
class ServiceInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.User.V2.ServiceInstance {}>'.format(context)
