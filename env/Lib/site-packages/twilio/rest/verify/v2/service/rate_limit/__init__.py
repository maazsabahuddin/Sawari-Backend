...
class RateLimitList(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.RateLimitList>'
...
class RateLimitPage(Page):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.RateLimitPage>'
...
class RateLimitContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.User.V2.RateLimitContext {}>'.format(context)
...
class RateLimitInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.User.V2.RateLimitInstance {}>'.format(context)
