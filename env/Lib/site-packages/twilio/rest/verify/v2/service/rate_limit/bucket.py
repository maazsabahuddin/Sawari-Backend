...
class BucketList(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.BucketList>'
...
class BucketPage(Page):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.BucketPage>'
...
class BucketContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.User.V2.BucketContext {}>'.format(context)
...
class BucketInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.User.V2.BucketInstance {}>'.format(context)
