...
class VerificationList(ListResource):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.VerificationList>'
...
class VerificationPage(Page):
    ...
    def __repr__(self):
        ...
        :rtype: str
        """
        return '<Twilio.User.V2.VerificationPage>'
...
class VerificationContext(InstanceContext):
    ...
    def __repr__(self):
        ...
        return '<Twilio.User.V2.VerificationContext {}>'.format(context)
...
class VerificationInstance(InstanceResource):
    ...
    def __repr__(self):
        ...
        """
        context = ' '.join('{}={}'.format(k, v) for k, v in self._solution.items())
        return '<Twilio.User.V2.VerificationInstance {}>'.format(context)
